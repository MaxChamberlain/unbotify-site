  ...
  return (
    <div className="relative pb-32">
      <div className="z-50 mx-auto flex w-screen max-w-7xl flex-col items-center justify-center gap-8 pt-12">
        ...
        <div className="w-full max-w-2xl" key="contact">
            ...
            <CardContent>
              <div className="grid w-full items-center gap-4">
                <div className="flex flex-col space-y-4">
                  <Input label="Name" placeholder="Who are you?" required type="text" autoComplete="name" disabled />
                  <Input
                    label="Email"
                  ...
                  />
                  <Select disabled>
                    <SelectTrigger label="Type" className="w-full" disabled>
                  ...
                  <Textarea label="Message" placeholder="What's your message?" required disabled />
                  <Button type="submit" className="w-full !bg-indigo-500" disabled>
                    Hold on...
                  </Button>
                </div>
              </div>
