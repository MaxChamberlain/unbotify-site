  ...
  return (
    <div className="relative pb-32">
      <div className="z-50 mx-auto flex w-screen max-w-7xl flex-col items-center justify-center gap-8 pt-12">
        <Badge className="animate-in fade-in-0 zoom-in-95 !bg-indigo-500/15 !text-indigo-500 duration-700">
          We&apos;d love to hear from you!
        </Badge>
        <h1 className="animate-in fade-in-0 zoom-in-95 text-4xl font-bold duration-700">Contact us</h1>
        <p className="text-muted-foreground animate-in fade-in-0 zoom-in-95 max-w-2xl text-center duration-700">
