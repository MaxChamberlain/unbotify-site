	...
	return (
		<div className="relative pb-32">
			<div className="z-50 mx-auto flex w-screen max-w-7xl flex-col items-center justify-center gap-8 pt-12">
				<Badge className="fade-in-0 zoom-in-95 !bg-indigo-500/15 !text-indigo-500 animate-in duration-700">
					We&apos;d love to hear from you!
				</Badge>
				<h1 className="fade-in-0 zoom-in-95 animate-in font-bold text-4xl duration-700">
					Contact us
				</h1>
				<p className="fade-in-0 zoom-in-95 max-w-2xl animate-in text-center text-muted-foreground duration-700">
					Want to get project specifications or pricing? Or just want to ask
					about one of our services? We&apos;re here to get you the best
									...
									<form onSubmit={form.handleSubmit(handleSubmit)}>
										<div className="grid w-full items-center gap-4">
											<div className="flex flex-col space-y-4">
												...
												<div
													className={cn(
														"-mt-4 max-h-0 overflow-y-hidden blur-sm transition-all duration-500",
														{
															"mt-0 max-h-32 blur-none":
												...
												<Button
													...
													disabled={
														sendEmail.isPending || !form.formState.isValid
													}
												>
													{sendEmail.isPending && (
