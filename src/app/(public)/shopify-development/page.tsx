  ...
  return (
    <div className="flex flex-col items-center gap-20 [&_section]:px-8">
        ...
        <div className="mx-auto flex w-screen max-w-7xl justify-center gap-12">
          ...
          <div className="relative flex h-full w-full flex-2 flex-col items-center justify-center gap-8 max-lg:hidden">
            <Image
              ...
              width={1000}
              height={1000}
              className="animate-in fade-in-0 zoom-in-95 slide-in-from-right-12 w-72 duration-700 ease-in-out"
            />
          </div>
        </div>
      </section>
      <section className="mx-auto grid w-screen max-w-7xl grid-cols-1 gap-16 py-16 md:!px-0 lg:grid-cols-2">
        <div className="animate-in fade-in-0 zoom-in-95 slide-in-from-right-12 flex max-w-xl flex-col items-start gap-6 text-start duration-700 ease-in-out">
        ...
        <div className="border-border animate-in fade-in-0 zoom-in-95 slide-in-from-left-12 flex max-h-64 flex-col gap-4 overflow-hidden rounded-2xl border p-2 shadow-lg duration-700 ease-in-out">
          <Image
      ...
      >
        ...
        <div className="border-border animate-in fade-in-0 zoom-in-95 slide-in-from-left-12 flex max-h-72 flex-col gap-4 overflow-hidden rounded-3xl border shadow-lg duration-700 ease-in-out">
          <Image
      ...
      >
        ...
        <div className="animate-in fade-in-0 zoom-in-95 slide-in-from-left-12 border-border flex max-h-72 flex-col gap-4 overflow-hidden rounded-3xl border px-24 shadow-lg duration-700 ease-in-out">
          <Image
      ...
      <section className="flex w-screen justify-center bg-slate-100 py-16 md:!px-0">
        <div className="text-center">
          <div className="animate-in fade-in-0 zoom-in-95 slide-in-from-right-12 flex max-w-xl flex-col items-center gap-6 text-center duration-700 ease-in-out">
