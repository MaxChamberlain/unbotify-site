                ...
                <div className="px-6 pb-4">
                  ...
                  <div className="space-y-4 pt-4 pb-4">
                    <div className="grid grid-cols-1 xl:grid-cols-2">
                      <div className="group p-4 transition-colors duration-200 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <div className="flex gap-2">
                          <div className="flex flex-1 flex-col gap-2">
                            <div className="flex size-8 items-center justify-center gap-2 rounded-lg bg-red-100">
                              <Receipt className="size-4 text-red-500" />
                            </div>
                            <h3 className="text-foreground flex items-center text-sm font-bold">
                              Inflated Marketing Bills
                            </h3>
                            <p className="text-foreground/80 max-w-md text-sm">
                              Bots inject fake emails into your marketing platforms like Klaviyo and MailChimp, forcing
                              you to pay for profiles that will never convert. These fake subscribers bloat your lists
                              and drain your budget month after month.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="group p-4 transition-colors duration-200 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <div className="flex gap-2">
                          <div className="flex flex-1 flex-col gap-2">
                            <div className="flex size-8 items-center justify-center gap-2 rounded-lg bg-red-100">
                              <DatabaseZap className="size-4 text-red-500" />
                            </div>
                            <h3 className="text-foreground flex items-center text-sm font-bold">Destroyed Analytics</h3>
                            <p className="text-foreground/80 max-w-md text-sm">
                              When bot traffic floods your store, your conversion rates plummet and your data becomes
                              worthless. You can't trust your metrics to make informed decisions about inventory,
                              marketing spend, or website improvements.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="group p-4 transition-colors duration-200 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <div className="flex gap-2">
                          <div className="flex flex-1 flex-col gap-2">
                            ...
                            <h3 className="text-foreground flex items-center text-sm font-bold">Wasted Ad Spend</h3>
                            <p className="text-foreground/80 max-w-md text-sm">
                              Marketing pixels fire on bot sessions, polluting your retargeting audiences and
                              attribution data. You're optimizing campaigns based on fake engagement, leading to poor
                              ROAS and misallocated budgets.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className="group p-4 transition-colors duration-200 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        <div className="flex gap-2">
                          <div className="flex flex-1 flex-col gap-2">
                            ...
                            <p className="text-foreground/80 max-w-md text-sm">
                              Your team wastes countless hours investigating fake orders, cleaning up email lists, and
                              trying to separate real customers from sophisticated bot traffic that mimics genuine user
                              behavior.
                            </p>
                          </div>
                        </div>
