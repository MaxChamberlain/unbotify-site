		...
		<div className="flex flex-col items-center gap-20 [&_section]:px-8">
			<Fragment>
				<div
					...
					data-id="da5e3291-d3e0-4368-8a5f-40cf084b4cf7"
					data-lazyload="false"
					data-mode="shadow"
				/>
				<Script
					...
					src="https://widget.senja.io/widget/da5e3291-d3e0-4368-8a5f-40cf084b4cf7/platform.js"
				/>
			</Fragment>
			<section className="flex w-screen max-w-7xl justify-center gap-12 pt-48 max-lg:flex-col md:pt-56">
			...
			<section className="w-full max-w-7xl max-md:hidden">
				<Badge
					variant="outline"
			...
			<section className="w-screen gap-6 bg-muted py-12">
				<div className="fade-in-0 zoom-in-95 z-50 mx-auto flex w-full max-w-7xl animate-in flex-col gap-6 duration-700">
					...
					<div className="fade-in-0 flex animate-in gap-12 overflow-x-scroll pb-4 duration-700">
						<FeatureCard
