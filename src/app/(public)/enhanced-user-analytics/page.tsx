  ...
  return (
    <div className="flex flex-col items-center gap-20 [&_section]:px-8">
      <section className="flex w-screen items-center justify-center gap-2 bg-gradient-to-tr from-sky-50 to-indigo-50 !px-0 py-16">
        ...
        />
        <span className="animate-in fade-in-0 slide-in-from-right-2 text-4xl font-bold duration-700">Enhanced</span>
        <h1 className="animate-in fade-in-0 slide-in-from-right-2 w-32 text-4xl font-bold duration-700">analytics</h1>
      </section>
